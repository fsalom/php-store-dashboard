...
while($row = mssql_fetch_array($result)){
	...
	$queryDetail = "SELECT Factuurnummer, Artikelnummer, Omschrijving, Verkoopprijs, origverkoopprijs, Aantal FROM VerkoopDetail WHERE Factuurnummer = ".$row["Factuurnummer"];
	...
	while($rowDetail =mssql_fetch_array($resultDetail)){
			...
			$subtotalO+=$subtotalOriginal*$items;
...
/********************************************************************************************************************
LLAMADA PRINCIPAL
Este cron trae del servidor de BECOSOFT todos los tickets > que el numero de ticket que fijamos en la variable $begin
Ejemplo: 
	$begin='12548';

Se traera todo los tickets 12549, 12550.... hasta el �ltimo  
********************************************************************************************************************/
//$begin='30144';
get_data($begin);
